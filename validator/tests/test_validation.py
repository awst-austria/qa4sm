...
class TestValidation(TestCase):
    ...
    #     radii = [0, 10000, None]
    #     # radius:
    #     # - 0: Switch is on, but a radius of 0 is selected --> same as radius = None
    #     # - 10k: Switch is on an points are averaged
    #     # - None: switch is off, single, nearest point extracted
    #     for radius in radii:
