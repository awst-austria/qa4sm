...
class DatasetConfiguration(models.Model):
    ...
    dataset = models.ForeignKey(to=Dataset, on_delete=models.PROTECT, related_name='data_dataset', null=False)
    version = models.ForeignKey(to=DatasetVersion, on_delete=models.PROTECT, related_name='data_version', null=False)
    variable = models.ForeignKey(to=DataVariable, on_delete=models.PROTECT, related_name='data_variable', null=False)
    filters = models.ManyToManyField(DataFilter, related_name='data_filters')
