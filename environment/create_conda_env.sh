...
conda create --yes --prefix $PYTHON_ENV_DIR -c conda-forge python=3.8 numpy scipy pandas cython pytest==5.4.3 pip matplotlib pyproj django==3.1.3 pyresample pygrib cartopy xarray
