...
conda create --yes --prefix $PYTHON_ENV_DIR -c conda-forge python=3.6 numpy scipy pandas=0.24.2 cython pytest pip matplotlib pyproj django pyresample pygrib cartopy
